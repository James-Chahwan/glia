...
Inputs:
  ...
  --out-dir <path>   default: bench/lens/cycle/

Reads:
  bench/lens/cycle/<cycle>-results.jsonl        (per-instance final outcome)
  bench/latent/out/inst-<id>-7b-q4-cycle-<tag>/beam_matrix.jsonl
...
LENS_ROOT = Path("/home/ivy/Code/glia/bench/lens")
LATENT_OUT = Path("/home/ivy/Code/glia/bench/latent/out")
SMOKE_PREFIX = "smoke-"
