...
LOG=/home/ivy/Code/glia/bench/lens/cycle/auto8h-index.md
START=$(date +%s)
...
mv /home/ivy/Code/glia/bench/latent/out/file_priors /home/ivy/Code/glia/bench/latent/out/file_priors.disabled 2>/dev/null || true
mv /home/ivy/Code/glia/bench/latent/out/exemplars /home/ivy/Code/glia/bench/latent/out/exemplars.disabled 2>/dev/null || true
GLIA_TWO_PASS=1 GLIA_SAGE_RUNTIME=1 GLIA_RUNTIME_EVIDENCE=1 \
GLIA_PER_TOKEN_POOL=1 GLIA_SAMPLES=3 GLIA_LENS_TRACE=0 \
GLIA_COMPOSITIONAL=1 N_GPU_LAYERS=99 AUTO_HOLDOUT=0 \
./cycle/run_cycle_loop.sh 1.5-no-priors 14b-q4 2>&1 | tail -20 | tee -a "$LOG"
mv /home/ivy/Code/glia/bench/latent/out/file_priors.disabled /home/ivy/Code/glia/bench/latent/out/file_priors 2>/dev/null || true
mv /home/ivy/Code/glia/bench/latent/out/exemplars.disabled /home/ivy/Code/glia/bench/latent/out/exemplars 2>/dev/null || true
...
for INST in pytest-dev__pytest-11143 sphinx-doc__sphinx-10325 matplotlib__matplotlib-22835; do
  SPLIT="test"
  rm -rf /home/ivy/Code/glia/bench/latent/out/inst-${INST}-14b-q4-1.6-beam8
  echo "=== $INST ===" >> "$LOG"
  GLIA_TWO_PASS=1 GLIA_SAGE_RUNTIME=1 GLIA_RUNTIME_EVIDENCE=1 \
...
CYCLES_DIR = Path("/home/ivy/Code/glia/bench/lens/cycle")
