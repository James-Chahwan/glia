...
4. **Latent mechanism upgrade**? Per-token embedding + marker tokens around pool cells (replacing mean-pool). The "real" graph-injection channel. ~4-6h Rust in `bench/lens/` extension.
