...
LOOP = GLIA / "bench/lens/manifests/cycle_loop_set.json"
HOLDOUT = GLIA / "bench/lens/manifests/holdout.json"
...
cd /home/ivy/Code/glia/bench/latent/out
...
ls /home/ivy/Code/glia/bench/lens/target/release/lens* 2>/dev/null | head -5
...
echo "  cd /home/ivy/Code/glia/bench/lens && \\"
