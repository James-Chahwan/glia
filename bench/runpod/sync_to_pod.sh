...
rsync -avz --partial --progress \
  ...
  --exclude 'bench/latent/out/inst-*' \
  --exclude 'bench/lens/cycle/*-stderr.log' \
  --exclude 'bench/3d-viewer/target/' \
  --exclude 'bench/tui-viewer/target/' \
  /home/ivy/Code/glia/ \
...
import json
loop = json.load(open('/home/ivy/Code/glia/bench/lens/manifests/cycle_loop_set.json'))
holdout = json.load(open('/home/ivy/Code/glia/bench/lens/manifests/holdout.json'))
...
echo
echo "=== sync done ==="
echo "Next on the pod:  bash /home/ivy/Code/glia/bench/runpod/setup.sh"
